...
const roadmapSteps = [
  ...
  {
    title: "Public Beta",
    description: "Open access for all guilds to test and provide feedback.",
    icon: "4",
    status: "future",
  },
  {
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {roadmapSteps.map((step, index) => (
              ...
              >
                ...
                {step.status === "current" && (
                  <span className="inline-block px-3 py-1 mt-2 rounded-full text-xs bg-gradient-to-r from-primary to-orange-500 text-white font-bold shadow-lg shadow-primary/50">
                    CURRENT
                  </span>
                )}
              </motion.div>
